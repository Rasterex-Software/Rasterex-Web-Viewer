...
export class RXCore {
  ...
  public static documentTextSearch(
    text: string | undefined,
    casesens: boolean = false,
  ...
  public static insertBlankPages(
    pageRange: number[][],
    count: number,
    width: number,
    height: number
  ...
  public static clearMarkup(): void {
    RxCore.clearMarkup();
  }
 ...
 */
  ...
  public static onGuiMarkupLoadComplete(
    callback: (markups: any, fileindex: any, activefile: any) => void
  ): void {
  ...
  public static onGui3DCameraSave(
    callback: (camera: any, fileActive: boolean) => void
  ): void {
  ...
  public static onGuiPagethumb(
    callback: (pageindex: number, thumbnail: any) => void
  ): void {
